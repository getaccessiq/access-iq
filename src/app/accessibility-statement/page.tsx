...
const measures = [
  "Regular accessibility reviews of design, structure, and user journeys",
...
const summaryItems = [
  ...
  "Accessibility is reviewed continuously.",
  "Feedback can be sent directly to our support team.",
];
      ...
      <section className="relative mx-auto max-w-6xl px-6 py-20 md:py-24">
        ...
        <div className="max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-gray-300">
            AccessIQ is committed to making our website accessible to as many
            people as possible, including people with disabilities. We
            continuously improve usability and align our digital experience with
            relevant accessibility standards to support inclusive access for all
            users.
          </p>
              ...
              <div className="space-y-12">
                ...
                <section>
                  ...
                  <p className="mt-4 leading-relaxed text-gray-300">
                    ...
                    Guidelines (WCAG) 2.2 Level AA and considers broader
                    accessibility expectations related to the Americans with
                    Disabilities Act (ADA), Section 508, and EN 301 549.
                  </p>
                ...
                <section>
                  ...
                  <p className="mt-4 leading-relaxed text-gray-300">
                    ...
                    conform to WCAG 2.2 Level AA across its public-facing
                    website experience.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="mt-4 leading-relaxed text-gray-300">
                    ...
                    review and ongoing testing methods.
                  </p>
                ...
                <section>
                  ...
                  <p className="mt-4 leading-relaxed text-gray-300">
                    Despite our best efforts to ensure accessibility, some
                    content may not yet fully conform to the highest
                    accessibility expectations in every scenario. We are
                    continuously working to improve the experience.
                  </p>
                  <p className="mt-4 leading-relaxed text-gray-300">
                    If you encounter an accessibility barrier, please contact us
                    and we will do our best to provide the information or
                    support you need in an accessible format.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="mt-4 leading-relaxed text-gray-300">
                    ...
                    digital experience for all users over time.
                  </p>
                </section>
              </div>
            </div>
            ...
            <aside className="border-t border-white/10 bg-white/[0.02] px-6 py-10 md:px-8 md:py-12 lg:border-l lg:border-t-0">
              <div className="space-y-6">
                <div className="rounded-2xl border border-[#00d4aa]/20 bg-[#00d4aa]/[0.05] p-5">
                  ...
                  <p className="text-base font-medium text-white">March 18, 2026</p>
                </div>
