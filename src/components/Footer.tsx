...
const footerLinks = {
  pages: [
    ...
    { label: "Pricing", href: "/prices" },
    {
      ...
      external: true,
      ariaLabel: "View demo (opens in a new tab)",
    },
  ],
  company: [
...
const baseLinkClass =
  "text-[15px] text-gray-300 transition-colors hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#36bfff] focus-visible:ring-offset-2 focus-visible:ring-offset-[#070d18] rounded-sm";

const socialButtonClass =
  "flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 bg-white/[0.03] shadow-[0_10px_25px_rgba(0,0,0,0.18)] transition-all hover:border-white/20 hover:bg-white/[0.06] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#36bfff] focus-visible:ring-offset-2 focus-visible:ring-offset-[#070d18]";

const sectionLabelClass =
  "mb-6 text-[13px] font-semibold uppercase tracking-[0.16em] text-white";
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-6 pt-16 pb-8">
        <ScrollReveal animation="fade-in" duration={800}>
          <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-[1.1fr_0.8fr_0.8fr_0.9fr_1.2fr] lg:gap-12">
            {/* Brand */}
            <div className="pr-0 lg:pr-4">
              ...
              >
                <Image
                  ...
                  width={300}
                  height={70}
                  className="h-[48px] w-auto object-contain lg:h-[58px]"
                />
              </Link>

              <div className="mb-2">
                <div
                  className="relative inline-block rounded-[24px] border border-white/8 bg-white/[0.02] p-2 shadow-[0_18px_50px_rgba(0,0,0,0.28)]"
                  aria-hidden="true"
                >
                  <Image
                    ...
                    width={540}
                    height={150}
                    className="h-auto w-[300px] rounded-[18px] object-contain md:w-[340px]"
                    unoptimized
                  />
                </div>
              </div>
              ...
              <ul className="space-y-5">
                {footerLinks.resources.map((item) => (
                  <li key={item.label}>
                    <Link
                      href={item.href}
                      className={`text-[15px] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#36bfff] focus-visible:ring-offset-2 focus-visible:ring-offset-[#070d18] rounded-sm ${
                ...
                <ul className="space-y-5">
                  <li className="flex items-center gap-4">
                    ...
                    <a
                      ...
                      aria-label="Email support@getaccessiq.com"
                      className={baseLinkClass}
                    >
                  ...
                  <li className="flex items-start gap-4">
                    <div
                      className="mt-1 flex flex-shrink-0 items-center justify-center"
                      aria-hidden="true"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      aria-label="Open office location in Google Maps (opens in a new tab)"
                      className="max-w-[260px] rounded-sm text-[15px] leading-[1.55] text-gray-300 transition-colors hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#36bfff] focus-visible:ring-offset-2 focus-visible:ring-offset-[#070d18]"
                    >
        ...
        <div
          aria-hidden="true"
          className="mb-6 mt-12 h-px w-full"
          style={{
            background:
          ...
          <div className="flex flex-col items-center justify-between gap-5 lg:flex-row">
            ...
            <div className="flex flex-col items-center gap-2 text-center text-[13px] text-gray-400 lg:flex-row lg:gap-4">
              ...
              <Link
                ...
                className="inline-flex items-center gap-1.5 rounded-sm text-[#36bfff] transition-colors hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#36bfff] focus-visible:ring-offset-2 focus-visible:ring-offset-[#070d18]"
              >
