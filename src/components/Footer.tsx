...
const socialButtonClass =
  "flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 bg-white/[0.03] shadow-[0_10px_25px_rgba(0,0,0,0.18)] transition-all hover:border-white/20 hover:bg-white/[0.06]";
      ...
      <div className="relative z-10 container mx-auto px-6 pt-16 pb-8">
        <ScrollReveal animation="fade-in" duration={800}>
          <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-[1.1fr_0.8fr_0.8fr_0.9fr_1.2fr] lg:gap-12">
            ...
            {/* Pages */}
            <div>
              <h4 className="mb-6 text-[13px] font-semibold uppercase tracking-[0.16em] text-white">
                Pages
              </h4>
              ...
              <ul className="space-y-5">
                ...
                <li className="flex items-start gap-4">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="max-w-[260px] text-[15px] leading-[1.55] text-gray-300 transition-colors hover:text-white"
                  >
          ...
          <div className="flex flex-col items-center justify-between gap-5 lg:flex-row">
            ...
            <div className="flex flex-col items-center gap-2 text-center text-[13px] text-gray-400 lg:flex-row lg:gap-4">
              ...
              <Link
                ...
                className="inline-flex items-center gap-1.5 text-[#36bfff] transition-colors hover:text-white"
              >
