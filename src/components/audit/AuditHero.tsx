  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
          ...
          <div className="grid min-h-[500px] items-center gap-10 lg:grid-cols-2 lg:gap-10">
            ...
            <div className="max-w-[590px]">
              ...
              <ScrollReveal animation="fade-in-up" delay={200}>
                <h1
                  id="audit-hero-title"
                  className="mb-6 text-[42px] font-semibold leading-[1.02] tracking-[-0.05em] text-white md:text-[56px] xl:text-[68px]"
                >
                  Accessibility Audits
                  <br />
                  Reduce Legal Risk
                  <br />
                  <span className="text-[#25cfff]">
                    Prove Compliance.
                  </span>
                </h1>
              </ScrollReveal>
              ...
              <ScrollReveal animation="fade-in-up" delay={280}>
                <p className="mb-8 max-w-[560px] text-[16px] leading-[1.65] text-white/85 md:text-[18px]">
              ...
              <ScrollReveal animation="fade-in-up" delay={360}>
                <div className="mb-7 flex flex-col items-start gap-3 sm:flex-row sm:items-center">
                  <Link
                    href="/contact"
                    className="inline-flex min-h-[52px] min-w-[250px] items-center justify-center rounded-full bg-gradient-to-r from-[#22d9c9] to-[#25beff] px-8 py-4 text-[15px] font-semibold text-white shadow-[0_16px_40px_rgba(36,191,255,0.22)] transition-all duration-300 hover:scale-[1.015] hover:shadow-[0_22px_48px_rgba(36,191,255,0.30)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#7ddfff] focus-visible:ring-offset-2 focus-visible:ring-offset-[#06101a]"
                  ...
                  <Link
                    href="/sample-report"
                    className="inline-flex min-h-[52px] min-w-[230px] items-center justify-center rounded-full border border-white/15 bg-white/[0.02] px-8 py-4 text-[15px] font-semibold text-white transition-all duration-300 hover:scale-[1.015] hover:border-white/30 hover:bg-white/[0.05] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#7ddfff] focus-visible:ring-offset-2 focus-visible:ring-offset-[#06101a]"
                    aria-label="View a sample accessibility report"
                  >
                    View Sample Report
                  </Link>
                </div>
        ...
        {/* Bottom info strip */}
        <div className="mt-12 border-t border-white/[0.06] md:mt-16 lg:mt-8">
          <div className="mx-auto max-w-[1400px] px-4 py-4 md:px-6 md:py-5 lg:px-8">
            <div className="flex flex-col items-center justify-center gap-3 text-center md:flex-row md:gap-4">
              ...
              <p className="flex flex-wrap items-center justify-center gap-3 text-[12px] font-medium text-white/55 md:text-[13px]">
                <span>ADA</span>
